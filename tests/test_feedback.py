...
@pytest.mark.parametrize(
    ...
    [
        # Test case: All correct
        ([1, 2, 3, 4, 5, 6], [1, 2, 3, 4, 5, 6], 6, True),
        ...
        # Test case: All incorrect
        ([2, 5, 5, 6, 7, 2], [0, 0, 1, 3, 4, 4], 4, False),
...
@pytest.mark.parametrize(
    ...
    [
        # Test case: All correct
        ([1, 2, 3, 4, 5, 6, 7, 0], [1, 2, 3, 4, 5, 6, 7, 0], 8, True),
        ...
        # Test case: All incorrect
        ([2, 5, 5, 4, 3, 2, 1, 4], [0, 0, 7, 0, 7, 0, 6, 7], 8, False),
